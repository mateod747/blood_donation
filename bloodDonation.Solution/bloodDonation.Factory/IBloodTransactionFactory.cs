...
namespace bloodDonation.Factory
{
    public interface IBloodTransactionFactory
    {
        ...
        Task<(Guid, BloodTransactionModel)> GetDonorIdAndBloodTransactionByUsernameAndDate(string username, int year, int month, int day);        Task<BloodTransactionModel> GetBloodTransaction(Guid id);
